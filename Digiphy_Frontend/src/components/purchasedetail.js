            ...
            <body class="page-login">
               <div id="content-block">
                  <div className="container be-detail-container your-purchase-bid">
                     <h4 className=" text-white mb-4">NFT Transaction Details</h4>
                     <div className="row">
                                    ...
                                    <div class="col-sm-8 login_edit_detail">
                                       <ul class="list-group task-list-group text-white">
                                          <li class="list-group-item list-group-item-action">
                                             <div class="n-chk"><label class=""><span class=" col-sm-6">NFT Name:</span><span class=" d-block col-sm-6">{this.state.transactionDetailAPIData?.item_name}</span></label></div>
                                          </li>
                                          <li class="list-group-item list-group-item-action">
                                             <div class="n-chk"><label class=""><span class=" col-sm-6">Edition:</span><span class=" d-block col-sm-6">{this.state.transactionDetailAPIData?.edition_text}</span></label></div>
                                          </li>
                                          <li class="list-group-item list-group-item-action">
                                             <div class="n-chk"><label class=""><span class=" col-sm-6">Owner:</span><span class=" d-block col-sm-6">{this.state.transactionDetailAPIData?.user_name ? this.state.transactionDetailAPIData?.user_name:this.state.transactionDetailAPIData?.full_name}</span></label></div>
                                          </li>
                                          <li class="list-group-item list-group-item-action">
                                             <div class="n-chk"><label class=""><span class=" col-sm-6">Price:</span><span class=" d-block col-sm-6">INR {this.state.transactionDetailAPIData?.amount} + DGB Coin {this.state.transactionDetailAPIData?.token}</span></label></div>
                                          </li>
                                          {/* <li class="list-group-item list-group-item-action">
            <div class="n-chk"><label class=""><span class=" col-sm-6">Token ID:</span><span class=" d-block col-sm-6">25</span></label></div>
         </li> */}
                                          <li class="list-group-item list-group-item-action">
                                             <div class="n-chk"><label class=""><span class=" col-sm-6">Date:</span><span class=" d-block col-sm-6">{this.state.transactionDetailAPIData?.datetime}</span></label></div>
                                          </li>
                                          <li class="list-group-item list-group-item-action">
                                             <div class="n-chk"><label class="">
                                                <span class=" col-sm-6">NFT Image:</span><span class=" d-block col-sm-6">
                                          ...
                                          <li class="list-group-item list-group-item-action">
                                             <div class="n-chk"><label class=""><span class=" col-sm-6">Transaction Status:</span><span class=" d-block col-sm-6">{this.state.transactionDetailAPIData?.status}</span></label></div>
                                          </li>
                                          {/* <li class="list-group-item list-group-item-action">
            <div class="n-chk"><label class=""><span class=" col-sm-6">Description:</span><span class=" d-block col-sm-6">The First Encounter: Travis siblings come across to what will be their first test of resilience, strength, and strategic planning. Copperhead, a CAT-IV Kaiju, emerges to threaten humanity at Shadow Basin, the series’ first villain, and a memorable one!</span></label></div>
         </li> */}
                                          ...
                                          {/* {this.state.transactionDetailAPIData?.transfer_hash === null || this.state.transactionDetailAPIData?.transfer_hash === undefined || this.state.transactionDetailAPIData?.transfer_hash === '' || this.state.transactionDetailAPIData?.status === 'Pending'
                                             ? '' :
                                             <li class="list-group-item list-group-item-action">
                                                <div class="n-chk"><label class=""><span class=" col-sm-6">Blockchain View:</span><span class=" d-block col-sm-6"><a href={this.state.transactionDetailAPIData?.transfer_hash} target="_blank" class="link"><button class="btn btn-primary">Blockchain View</button></a></span></label></div>
                                             </li>
                                          } */}

                                          {/* <li class="list-group-item list-group-item-action">
            <div class="n-chk"><label class=""><span class=" col-sm-6">Payment Mode:</span><span class=" d-block col-sm-6">Crypto</span></label></div>
         </li> */}
                                       </ul>
                                    </div>
                                    <div class="col-sm-2"></div>
