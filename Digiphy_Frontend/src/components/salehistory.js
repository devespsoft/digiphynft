   ...
   constructor(props) {
         ...
         },
         {
            ...
            cell: (item) => {
               return (
                  <>
                     {/* {item.status === 'Pending' ?  */}
                     <button onClick={this.getBidDetails.bind(this, item)} data-toggle="modal" data-target="#myModal" className="btn btn-primary" style={{ textTransform: 'inherit' }}>View Bids</button>
      ...
      this.columns1 = [
         ...
         },
         {
            ...
            cell: (item) => {
               return (
                  <span>INR {parseFloat(item.price).toFixed(2)}</span>
               );
            }
         },
            ...
            <body className="page-login" >
               <div id="content-block">
                  <div className="container be-detail-container your-purchase-bid">
                     <h3 className=" text-white mb-4">Sale history</h3>
                     <div className="row">
                        <ToastContainer />
                        ...
                        Choose Category
                              ...
                              <div className="creative_filds_block">
                                 <ul className="ul nav">
                                    ...
                                    <li className="edit-ln active" ><Link onClick={this.loading.bind(this, '3')} to={`${config.baseUrl}salehistory`}>Sale history</Link></li>
                              ...
                              <div className="tab-nav-wrapper">
                                 <div className="nav-tab  clearfix">
                                    <div className={`nav-tab-item ${(this.state.defaultActive === 'Price') ? 'active' : ''}`}>
                                       <span className='text-white'>Sale History</span>
                                    </div>
                                    <div className={`nav-tab-item ${(this.state.defaultActive !== 'Price') ? 'active' : ''}`}>
                                       <span className='text-white'>Bid History</span>
                                    </div>
                                                         ...
                                                         <div className="col-sm-12 background-shadow p-5">
                                                            ...
                                                            <div className="row">
                                                               <div className="col-sm-12 text-center">
                                                                  <h5 className="weak text-white">You don't have any collected creations available for sale.</h5>
                                                               </div>
                                                            </div>
                                    ...
                                    <div className="row">
                                       <div className="col-ml-12 col-xs-12 col-sm-12" style={{ marginTop: '-25px' }}>
					                      ...
					                      <tbody>
                                             ...
                                             ? 'images/team2.jpg' 
                                             :
                                             `${config.imageUrl1}${item.local_image}`} style={{width:'100px',height:'98px'}} alt=""/></td>
                  ...
                  <div className="modal-dialog" style={{ overflow: 'hidden' }}>
                     <div className="modal-content">
                        <div className="modal-header">
                           ...
                           <h4 className="modal-title text-white">Bid details of <b>{this.state.selectedBid.name}</b></h4>
                        </div>
                                 ...
                                 {(this.state.BidDetailData.length == 0) ?
                                    ...
                                    this.state.BidDetailData.map((item, i) => (
                                       <tr>
                                          <td>{item.bid_id}</td>
                                          <td>{item.full_name}</td>
                                          <td>INR {item.bid_price}</td>
                                          <td>{(item.datetime.replace('.000Z', '')).replace('T', ' ')}</td>
                                          <td><button data-dismiss="modal" aria-hidden="true" type="button" style={{ textTransform: 'inherit' }} onClick={this.approveBid.bind(this, item)} className="btn btn-sm btn-primary">Approve Bid</button></td>
                                       </tr>
                                    ))}
                              </tbody>
                           </table>
