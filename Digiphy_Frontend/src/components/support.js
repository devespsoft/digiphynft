...
export default class support extends Component {
   ...
   <div className="col-md-12">
                       <h3><strong>Contact us</strong></h3>
                        <hr/>
      <p style={{color:"#fff"}}>In case you face any difficulty or inconvenience within the DiGiphyNFT platform, kindly fill in the form below, and we shall contact you shortly.</p>
     <br/>
