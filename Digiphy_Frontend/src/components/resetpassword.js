 ...
 passwordEye1(id){
  ...
  this.setState({
    ...
    handleSubmit = event =>{
      ...
      axios.post(`${config.apiUrl}resetpassword/`+this.token, {password:password,password2:password2}, { headers })
          .then(result=>{
          // alert(' ALL field');
...
<ToastContainer/>
        ...
        <form className="login100-form validate-form" onSubmit={this.handleSubmit}>
         {/*   <div className="text-center mb-2">
          ...
          <label className="mt-0" style={{color:'#fff'}}>Password must be at least 8 characters and contain 1 special character or number.</label>
          <br/>
