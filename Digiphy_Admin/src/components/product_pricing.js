 ...
 */
   ...
   async getproduct_pricing() {
    ...
    async submitLandingForm(e) {
        ...
        var data = {
            ...
            product_pricing: this.state.product_pricing
            
        }
        await axios({
           method: 'post', 
           url: `${config.apiUrl}updateproduct_pricing`, data,
 ...
 updateContent = (value) => {
    this.setState({'product_pricing':value})
}  
                        ...
                        <div className="container-fluid pt-25">
                            <div className="row heading-bg">
                                <div className="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                    <h5 className="">Product Pricing</h5>
                                </div>
                            </div>
                            <div className="row">
                                                            ...
                                                            <div className="col-md-12">
                                                                ...
                                                                <div className="form-group">
                                                                    ...
                                                                    <JoditEditor
                                                                        ...
                                                                        value={this.state.landingPage?.product_pricing}
                                                                        config={this.config}
