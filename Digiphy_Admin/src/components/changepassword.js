                        ...
                        <div className="container-fluid">
                            ...
                            <div className="row heading-bg">
                                <div className="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                    <h5 className="" style={{ marginLeft: "15px" }}>Change Password</h5>
                                </div>
                                {/* <!-- Breadcrumb --> */}
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="password" id="firstName" onChange={this.handleChange} autoComplete="new-password"
                                                                    name="currentPassword" className="form-control" placeholder="Old Password" value={this.state.currentPassword} />
                                                            </div>
                                                        </div>
                                                        <div className="col-md-6">
                                                            <div className="form-group">
