 ...
 */
   ...
   async getrefund_pricing() {
    ...
    async submitLandingForm(e) {
        ...
        var data = {
            ...
            refund_pricing: this.state.refund_pricing
            
        }
        await axios({
           method: 'post', 
           url: `${config.apiUrl}updaterefund_pricing`, data,
 ...
 updateContent = (value) => {
    this.setState({'refund_pricing':value})
}  
                                                            ...
                                                            <div className="col-md-12">
                                                                ...
                                                                <div className="form-group">
                                                                    ...
                                                                    <JoditEditor
                                                                        ...
                                                                        value={this.state.landingPage?.refund_pricing}
                                                                        config={this.config}
